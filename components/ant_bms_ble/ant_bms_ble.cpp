...
void AntBmsBle::update() {
  if (this->enable_fake_traffic_) {
    // 16ZM, 16ZMUB00-211026A: 16S, 280 Ah, cold day, 1y runtime
    const uint8_t device_info_frame[48] = {0x7E, 0xA1, 0x12, 0x6C, 0x02, 0x20, 0x31, 0x36, 0x5A, 0x4D, 0x00, 0x00,
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x31, 0x36,
                                           0x5A, 0x4D, 0x55, 0x42, 0x30, 0x30, 0x2D, 0x32, 0x31, 0x31, 0x30, 0x32,
                                           0x36, 0x41, 0x72, 0x08, 0xFF, 0x0B, 0x00, 0x00, 0x41, 0xF2, 0xAA, 0x55};
    this->assemble_(device_info_frame, sizeof(device_info_frame));

    const uint8_t status_frame[152] = {
        };
    this->assemble_(status_frame, sizeof(status_frame));

    // 16ZMB0TB120A, 16ZMUB00-220501A: 14S, 150 Ah, room temperature, 109d 20h runtime
    const uint8_t status_frame2[148] = {
        };
    this->assemble_(status_frame2, sizeof(status_frame2));

    const uint8_t device_info_frame2[48] = {0x7E, 0xA1, 0x12, 0x6C, 0x02, 0x20, 0x31, 0x36, 0x5A, 0x4D, 0x42, 0x30,
                                            0x54, 0x42, 0x31, 0x32, 0x30, 0x41, 0x00, 0x00, 0x00, 0x00, 0x31, 0x36,
                                            0x5A, 0x4D, 0x55, 0x42, 0x30, 0x30, 0x2D, 0x32, 0x32, 0x30, 0x35, 0x30,
                                            0x31, 0x41, 0x25, 0x2B, 0xFF, 0x0B, 0x00, 0x00, 0x41, 0xF2, 0xAA, 0x55};
