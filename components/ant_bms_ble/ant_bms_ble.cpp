...
static const SettingsRegister SETTINGS_REGISTERS[] = {
    {0x0000, "CellHighProtect", 0.001f, "V"},
    {0x0002, "CellHighRecover", 0.001f, "V"},
    {0x0004, "CellHighProtectL2", 0.001f, "V"},
    {0x0006, "CellHighRecoverL2", 0.001f, "V"},
    {0x0008, "PackVoltHighProtect", 0.1f, "V"},
    {0x000a, "PackVoltHighRecover", 0.1f, "V"},
    {0x000c, "CellLowProtect", 0.001f, "V"},
    {0x000e, "CellLowRecover", 0.001f, "V"},
    {0x0010, "CellLowProtectL2", 0.001f, "V"},
    {0x0012, "CellLowRecoverL2", 0.001f, "V"},
    {0x0014, "PackVoltLowProtect", 0.1f, "V"},
    {0x0016, "PackVoltLowRecover", 0.1f, "V"},
    {0x0018, "CellDiffProtect", 0.001f, "V"},
    {0x001a, "CellDiffRecover", 0.001f, "V"},
    {0x0020, "CellHighWarning", 0.001f, "V"},
    {0x0022, "CellHighWarningRecover", 0.001f, "V"},
    {0x0024, "PackVoltHighWarning", 0.1f, "V"},
    {0x0026, "PackVoltHighWarningRecover", 0.1f, "V"},
    {0x0028, "CellLowWarning", 0.001f, "V"},
    {0x002a, "CellLowWarningRecover", 0.001f, "V"},
    {0x002c, "PackVoltLowWarning", 0.1f, "V"},
    {0x002e, "PackVoltLowWarningRecover", 0.1f, "V"},
    {0x0030, "CellDiffWarning", 0.001f, "V"},
    {0x0032, "CellDiffWarningRecover", 0.001f, "V"},
    {0x0068, "ChargeOverCurProtect", 0.1f, "A"},
    {0x006a, "ChargeOverCurProtectDelay", 1.0f, "s"},
    {0x006c, "DischargeOverCurProtect", 0.1f, "A"},
    {0x006e, "DischargeOverCurProtectDelay", 1.0f, "s"},
    {0x0070, "DischargeOverCurProtectL2", 0.1f, "A"},
    {0x0072, "DischargeOverCurProtectDelayL2", 1.0f, "ms"},
    {0x0074, "ShortCircuitProtect", 1.0f, "A"},
    {0x0076, "ShortCircuitProtectDelay", 1.0f, "us"},
    {0x007c, "ChargeOverCurWarning", 0.1f, "A"},
    {0x007e, "ChargeOverCurWarningRecover", 0.1f, "A"},
    {0x0080, "DischargeOverCurWarning", 0.1f, "A"},
    {0x0082, "DischargeOverCurWarningRecover", 0.1f, "A"},
    {0x0084, "SOCLowLevel1Warning", 1.0f, "%"},
    {0x0086, "SOCLowLevel2Warning", 1.0f, "%"},
    {0x008c, "CellBalLimit", 0.001f, "V"},
    {0x008e, "ChargingCellBalStart", 0.001f, "V"},
    {0x0090, "CellDiffOn", 0.001f, "V"},
    {0x0092, "CellDiffOff", 0.001f, "V"},
    {0x0094, "BalanceCurrent", 1.0f, "mA"},
    {0x0096, "BalanceChargingCurrent", 0.1f, "A"},
    {0x0098, "CellType", 1.0f, ""},
    {0x009a, "CellNumber", 1.0f, "S"},
    {0x009c, "CellLowR_Cal", 1.0f, "mOhm"},
    {0x009e, "ShutDownVolt", 0.001f, "V"},
    {0x00a0, "RequestChargeCurrent", 0.1f, "A"},
    {0x00a2, "PhysicalAH", 1.0f, "Ah"},
    {0x00a6, "RemainingAH", 1.0f, "Ah"},
    {0x00aa, "TotalCycleAH", 1.0f, "Ah"},
...
void AntBmsBle::read_settings(uint16_t address) {
  ...
  this->send_(ANT_COMMAND_DEVICE_INFO, address, data_len, false);
}
